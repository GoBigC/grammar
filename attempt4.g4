...
// Restructured if-statement to be completely unambiguous
ifStatement 
    : 'if' '(' expression ')' nonIfStatement
    | 'if' '(' expression ')' nonIfStatement 'else' statement
    | 'if' '(' expression ')' ifStatement 'else' statement
    ;

// A statement that isn't an if statement (removes ambiguity)
nonIfStatement
    : expressionStatement
    | compoundStatement
    | whileStatement
